function Contact() {
    return (
        <main className="relative w-full h-screen max-w-5xl mx-auto p-2 flex flex-col items-start justify-start gap-6 pt-16 overflow-scroll">
            <div className="w-full flex flex-col items-start justify-center gap-4 pt-4">
                <div className="w-full flex flex-col items-start justify-center">
                    <span className="text-xs sm:text-sm font-semibold text-(--text) text-shadow-sm/10">
                        $ whoami
                    </span>
                    <h1 className="text-base sm:text-lg font-semibold text-(--text) text-shadow-sm/10">
                ...
                <div className="w-full flex flex-col items-start justify-center gap-2">
                    ...
                    <p className="text-sm sm:text-base font-medium text-(--text-muted) text-shadow-sm/10">
            ...
            <div className="w-full flex flex-col items-start justify-start gap-4">
                <div className="w-full flex flex-col items-start justify-start gap-0">
                    ...
                    <p className="text-sm sm:text-base text-(--text-muted) font-medium text-shadow-sm/10">
                        vt79328@gmail.com
                    </p>
                </div>
                <div className="w-full flex flex-col items-start justify-start gap-0">
                    ...
                    <a
                        ...
                        target="_blank"
                        className="text-sm sm:text-base text-(--text-muted) font-medium text-shadow-sm/10 underline"
                    >
                        linkedin.com/vinay
                    </a>
                </div>
