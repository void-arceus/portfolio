        ...
        <main className="w-full max-w-5xl h-full mx-auto pt-16 p-2 flex flex-col gap-2">
            ...
            <div className="w-full overflow-scroll flex-1 grid grid-cols-1 md:grid-cols-2 auto-rows-max gap-2 font-monospace">
                <div className="h-40 border p-2 border-(--border) rounded-xl shadow-sm hover:shadow-md flex flex-col items-start justify-start gap-1">
                    ...
                    <div className="w-full flex flex-col items-start justify-center gap-1">
                        {skills?.languages.map((language, key) => (
                            <p
                                key={key}
                                className="text-sm font-semibold text-shadow-sm/10 text-(--text)"
                            >
                                - {language}
                            </p>
                        ))}
                ...
                <div className="h-40 border p-2 border-(--border) rounded-xl shadow-sm hover:shadow-md flex flex-col items-start justify-start gap-1">
                    ...
                    <div className="w-full flex flex-col items-start justify-center gap-1">
                        {skills?.frontend.map((skill, key) => (
                            <p
                                key={key}
                                className="text-sm text-(--text) font-semibold text-shadow-sm/10"
                            >
                                - {skill}
                            </p>
                        ))}
                ...
                <div className="h-40 border p-2 border-(--border) rounded-xl shadow-sm hover:shadow-md flex flex-col items-start justify-start gap-1">
                    ...
                    <div className="w-full grid grid-rows-5 grid-cols-2 gap-1">
